...
export interface ITextFieldProps extends Omit<TextInputProps, 'ref'> {
   ...
   * Example: `RightAccessory={(props) => <Icon icon="ladybug"
   * containerStyle={props.style} color={props.editable ? colors.textDim : colors.text} />}`
   * Note: It is a good idea to memoize this.
   */
  RightAccessory?: ComponentType<ITextFieldAccessoryProps>;
  /**
   * An optional component to render on the left side of the input.
   * Example: `LeftAccessory={(props) => <Icon icon="ladybug"
   * containerStyle={props.style} color={props.editable ? colors.textDim : colors.text} />}`
   * Note: It is a good idea to memoize this.
   */
 ...
 */
export const TextField = forwardRef((props: ITextFieldProps, ref: Ref<TextInput>) => {
  const {
    labelTx,
    label,
    labelTxOptions,
