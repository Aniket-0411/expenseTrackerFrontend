...
/**
 *  This is where you put your crash reporting service initialization code to
 * call in `./app/app.tsx`
 */
export const initCrashReporting = () => {
  ...
  // information if something goes wrong with sending the event. Set it to `false`
  // in production
  // })
  // Bugsnag.start("YOUR API KEY")

  console.info('Log this to Sentry');
};
