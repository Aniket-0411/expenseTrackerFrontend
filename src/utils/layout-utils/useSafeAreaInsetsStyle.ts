...
/**
 * A hook that can be used to create a safe-area-aware style object that can be
 * passed directly to a View.
 ...
 * @returns {SafeAreaInsetsStyle<Property, Edges>} - The style object with the
